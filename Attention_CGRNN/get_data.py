...
class GetValues:
    ...
    def get_parameters(self,**kwargs):
        ...
        self.model=kwargs.get('model','ACRNN')               # Name of model
        self.feature=kwargs.get('feature','logmel')        # Name of feature
        
        self.dropout=kwargs.get('dropout',[0.1,0.2])             # 1st Dropout
        self.act1=kwargs.get('act1','tanh')                # 1st Activation
        self.act2=kwargs.get('act2','linear')             # 2nd Activation
        self.act3=kwargs.get('act3','sigmoid')                # 3rd Activation
        self.nb_filter=kwargs.get('nb_filter',72)
        self.filter_length=kwargs.get('filter_length',4)

        self.input_neurons=kwargs.get('input_neurons',300) # Number of Neurons
        self.epochs=kwargs.get('epochs',10)                # Number of Epochs
        self.batchsize=kwargs.get('batchsize',128)         # Batch Size
