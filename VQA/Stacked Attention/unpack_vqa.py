...
######### PREPARE DATA #############################################
if train== 1:
    train_anno = json.load(open(q+'annotations/v2_mscoco_train2014_annotations.json', 'r'))
    val_anno = json.load(open(q+'annotations/v2_mscoco_val2014_annotations.json', 'r'))
    train_ques = json.load(open(q+'annotations/v2_OpenEnded_mscoco_train2014_questions.json', 'r'))
    val_ques = json.load(open(q+'annotations/v2_OpenEnded_mscoco_val2014_questions.json', 'r'))
    ...
    train_ques = json.load(open(q+'annotations/v2_OpenEnded_mscoco_train2014_questions.json', 'r'))
    val_ques = json.load(open(q+'annotations/v2_OpenEnded_mscoco_val2014_questions.json', 'r'))
    test_ques = json.load(open(q+'annotations/v2_OpenEnded_mscoco_test2015_questions.json', 'r'))
