...
def get_tokens(imgs,token_method,print_proc=True):
...
def encode_answer(imgs, atoi):
    ...
    for i, img in enumerate(imgs):
        ans_arrays[i] = atoi.get(img['ans'], -1)
...
if train== 1:
    ...
    train_anno = json.load(open(q+'annotations1/mscoco_train2014_annotations.json', 'r'))
    val_anno = json.load(open(q+'annotations1/mscoco_val2014_annotations.json', 'r'))
    train_ques = json.load(open(q+'annotations1/MultipleChoice_mscoco_train2014_questions.json', 'r'))
    val_ques = json.load(open(q+'annotations1/MultipleChoice_mscoco_val2014_questions.json', 'r'))
    ...
    train_ques = json.load(open(q+'annotations1/MultipleChoice_mscoco_train2014_questions.json', 'r'))
    val_ques = json.load(open(q+'annotations1/MultipleChoice_mscoco_val2014_questions.json', 'r'))
    test_ques = json.load(open(q+'annotations1/MultipleChoice_mscoco_test2015_questions.json', 'r'))
